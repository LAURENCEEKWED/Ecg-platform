...
import { Heart, Activity, FileText, User, Save, Camera, X, Check } from 'lucide-react';
...
export default function PatientProfile() {
  ...
  return (
    <AppLayout navItems={NAV_ITEMS} title="My Profile">
      <div style={{ maxWidth: 560 }}>
        <h1 style={{ fontSize: '1.4rem', marginBottom: 20 }}>My Profile</h1>
